...
/**
 * A stream wrapper for packages.
 */
class PackageStreamWrapper implements StreamWrapperInterface
{
    /**
     * @const string
     */
    ...
    {
        $resourceUriOrStream = $this->evaluatePackagePath($path);
    ...
    {
        $resourceUriOrStream = $this->evaluatePackagePath($path, false);
        if (is_string($resourceUriOrStream)) {
    ...
    /**
     * Evaluates the absolute path and filename of the package file specified
     * by the given path.
     *
     ...
     */
    protected function evaluatePackagePath($requestedPath, $checkForExistence = true)
    {
