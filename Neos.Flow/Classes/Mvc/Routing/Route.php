...
class Route
{
    ...
    /**
     * The lifetime that has been associated with this route during request matching, or NULL
     *
     * @var RouteLifetime|null
     */
    protected $matchedLifetime;
    ...
    /**
     * The lifetime that has been associated with this route during resolving, or NULL
     *
     * @var RouteLifetime|null
     */
    protected $resolvedLifetime;
     ...
     *
     * @param RouteTags|null $tags
     */
    public function setCacheTags(?RouteTags $tags): void
    {
        $this->cacheTags = $tags;
    }
     ...
     *
     * @param RouteLifetime|null $lifetime
     */
    public function setCacheLifetime(?RouteLifetime $lifetime): void
    {
     ...
     */
    public function getMatchedLifetime(): ?RouteLifetime
    {
        return $this->matchedLifetime;
    }
     ...
     * @return RouteLifetime|null
     */
    public function getResolvedLifetime(): ?RouteLifetime
    {
        return $this->resolvedLifetime;
    }
    ...
    public function matches(RouteContext $routeContext)
    {
        ...
        $this->matchedTags = $this->cacheTags ?? RouteTags::createEmpty();
        $this->matchedLifetime = $this->cacheLifetime ?? RouteLifetime::createUndefined();
    ...
    public function resolves(ResolveContext $resolveContext)
    {
        ...
        $this->resolvedTags = $this->cacheTags ?? RouteTags::createEmpty();
        $this->resolvedLifetime = $this->cacheLifetime ?? RouteLifetime::createUndefined();
        if ($this->uriPattern === null) {
            return false;
        }
        if (!$this->isParsed) {
