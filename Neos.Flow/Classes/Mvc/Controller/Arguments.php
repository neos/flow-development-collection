...
class Arguments extends \ArrayObject
{
    ...
    public function offsetUnset($offset): void
    {
        ...
        if ($translatedOffset === false) {
            throw new \Exception('Missing argument', 1744326231);
        }
    ...
    public function offsetExists($offset): bool
    {
        $translatedOffset = $this->validateArgumentExistence($offset);
        if ($translatedOffset === false) {
            throw new \Exception('Missing argument', 1744326202);
        }
    ...
    public function __call($methodName, array $arguments)
    {
        ...
        if ($firstLowerCaseArgumentName === false) {
            throw new \Exception('Missing argument', 1744326132);
        }
        $firstUpperCaseArgumentName = $this->validateArgumentExistence(ucfirst(substr($methodName, 3)));
        if ($firstUpperCaseArgumentName === false) {
            throw new \Exception('Missing argument', 1744326142);
        }
