 ...
 *
 */
class ObjectsConfigurationType extends AbstractConfigurationType
{
    /**
    ...
    public function process(YamlSource $configurationSource, string $configurationType, array $packages, array $configuration) : array
    {
        ...
        foreach ($packages as $packageKey => $package) {
            $settings = $configurationSource->load($package->getConfigurationPath() . $configurationType, $allowSplitSource);
            ...
            $configuration[$packageKey] = $settings;
        }
