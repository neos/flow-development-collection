...
class AbstractMethodInterceptorBuilderTest extends UnitTestCase
{
    ...
    public function buildMethodArgumentsArrayCodeRendersCodeForPassingParametersToTheJoinPoint()
    {
        ...
        $mockReflectionService->expects($this->any())->method('getMethodParameters')->with($className, 'foo')->will(self::returnValue($methodParameters));
    ...
    public function buildSavedConstructorParametersCodeReturnsTheCorrectParametersCode()
    {
        ...
        $mockReflectionService = $this->getMockBuilder(ReflectionService::class)->disableOriginalConstructor()->getMock();
        $mockReflectionService->expects($this->any())->method('getMethodParameters')->with($className, '__construct')->will(self::returnValue($methodParameters));
