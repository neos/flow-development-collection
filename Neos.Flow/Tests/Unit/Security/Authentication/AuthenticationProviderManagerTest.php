...
class AuthenticationProviderManagerTest extends UnitTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->mockSecurityContext = $this->getMockBuilder(Context::class)->disableOriginalConstructor()->setMethods(['initialize', 'canBeInitialized', 'getAuthenticationTokens', 'getAuthenticationStrategy'])->getMock();
