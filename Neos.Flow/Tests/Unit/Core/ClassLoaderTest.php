...
class ClassLoaderTest extends UnitTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->mockPackage1->expects($this->any())->method('getNamespaces')->will(self::returnValue(['Acme\\MyApp']));
        $this->mockPackage1->expects($this->any())->method('getPackagePath')->will(self::returnValue('vfs://Test/Packages/Application/Acme.MyApp/'));
        $this->mockPackage1->expects($this->any())->method('getFlattenedAutoloadConfiguration')->will(self::returnValue([
            [
        ...
        $this->mockPackage2->expects($this->any())->method('getNamespaces')->will(self::returnValue(['Acme\\MyAppAddon']));
        $this->mockPackage2->expects($this->any())->method('getPackagePath')->will(self::returnValue('vfs://Test/Packages/Application/Acme.MyAppAddon/'));
        $this->mockPackage2->expects($this->any())->method('getFlattenedAutoloadConfiguration')->will(self::returnValue([
            [
    ...
    public function classesFromOverlayedPsr4PackagesAreLoaded()
    {
        ...
        $mockPackage1->expects($this->any())->method('getNamespaces')->will(self::returnValue(['TestPackage\\Subscriber\\Log']));
        $mockPackage1->expects($this->any())->method('getFlattenedAutoloadConfiguration')->will(self::returnValue([
            [
        ...
        $mockPackage2->expects($this->any())->method('getFlattenedAutoloadConfiguration')->will(self::returnValue([
            [
    ...
    public function classesFromOverlayedPsr4PackagesAreOverwritten()
    {
        ...
        $mockPackage1 = $this->getMockBuilder(Package::class)->disableOriginalConstructor()->getMock();
        $mockPackage1->expects($this->any())->method('getNamespaces')->will(self::returnValue(['TestPackage\\Foo']));
        $mockPackage1->expects($this->any())->method('getFlattenedAutoloadConfiguration')->will(self::returnValue([
            [
        ...
        $mockPackage2 = $this->getMockBuilder(Package::class)->disableOriginalConstructor()->getMock();
        $mockPackage2->expects($this->any())->method('getNamespaces')->will(self::returnValue(['TestPackage']));
        $mockPackage2->expects($this->any())->method('getFlattenedAutoloadConfiguration')->will(self::returnValue([
            [
                'namespace' => 'TestPackage',
                'classPath' => 'vfs://Test/Packages/Libraries/test/mainPackage/src/',
