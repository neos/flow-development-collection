...
class NumberFormatterTest extends UnitTestCase
{
    ...
    public function formatMethodsAreChoosenCorrectly()
    {
        ...
        $formatter->expects(self::once())->method('formatDecimalNumber')->with($sampleNumber, $this->sampleLocale, NumbersReader::FORMAT_LENGTH_DEFAULT)->will(self::returnValue('bar1'));
        $formatter->expects(self::once())->method('formatPercentNumber')->with($sampleNumber, $this->sampleLocale, NumbersReader::FORMAT_LENGTH_DEFAULT)->will(self::returnValue('bar2'));
