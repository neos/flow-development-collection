    ...
    public static function getRenderMethodArgumentDefinitions(ObjectManagerInterface $objectManager)
    {
        ...
        foreach ($methodParameters as $parameterName => $parameterInfo) {
            ...
            if (isset($parameterInfo['type'])) {
                ...
                throw new \TYPO3\Fluid\Core\Exception('Could not determine type of argument "' . $parameterName . '" of the render-method in ViewHelper "' . static::class . '". Either the methods docComment is invalid or some PHP optimizer strips off comments.', 1242292003);
            }
