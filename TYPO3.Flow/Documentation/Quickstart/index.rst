...
can you imagine what they do? ::
	...
	class CoffeeBeanController extends ActionController {
		 ...
		 *
		 * @param CoffeeBean $coffeeBean A new coffee bean to add
		 */
		 ...
		 *
		 * @param CoffeeBean $coffeeBean The coffee bean to edit
		 */
		 ...
		 *
		 * @param CoffeeBean $coffeeBean The coffee bean to update
		 */
		 ...
		 *
		 * @param CoffeeBean $coffeeBean The coffee bean to delete
		 */
