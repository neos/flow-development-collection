 ...
 * @package		FLOW3
 * @subpackage	MVC
 * @version 	$Id:T3_FLOW3_MVC_Request.php 467 2008-02-06 19:34:56Z robert $
 * @copyright	Copyright belongs to the respective authors
 * @license		http://opensource.org/licenses/gpl-license.php GNU Public License, version 2
 *
 * @scope prototype
 */
class T3_FLOW3_MVC_Request {
	 ...
	 */
	protected $controllerName = 'T3_FLOW3_MVC_Controller_DefaultController';
	 ...
	 * @return void
	 * @author Robert Lemke <robert@typo3.org>
	 * @throws T3_FLOW3_MVC_Exception_RequestObjectAlreadyLocked if this request object is already locked
	 */
	public function setMethod($method) {
		if ($this->locked) throw new T3_FLOW3_MVC_Exception_RequestObjectAlreadyLocked('This request object is locked for write access.', 1181134253);
		$this->method = $method;
	}
	...
	public function setArgument($argumentName, $value) {
		if ($this->locked) throw new T3_FLOW3_MVC_Exception_RequestObjectAlreadyLocked('This request object is locked for write access.', 1181134254);
		if (!is_string($argumentName) || T3_PHP6_Functions::strlen($argumentName) == 0) throw new T3_FLOW3_MVC_Exception_InvalidArgumentName();
	...
	public function setArguments(ArrayObject $arguments) {
		if ($this->locked) throw new T3_FLOW3_MVC_Exception_RequestObjectAlreadyLocked('This request object is locked for write access.', 1181134255);
	 ...
	 * @author Robert Lemke <robert@typo3.org>
	 * @throws T3_FLOW3_MVC_Exception_NoSuchArgument if such an argument does not exist
	 */
	public function getArgument($argumentName) {
		if (!isset($this->arguments[$argumentName])) throw new T3_FLOW3_MVC_Exception_NoSuchArgument('An argument "' . $argumentName . '" does not exist for this request.', 1176558158);
	...
	public function setActionName($actionName) {
		if ($this->locked) throw new T3_FLOW3_MVC_Exception_RequestObjectAlreadyLocked('This request object is locked for write access.', 1186648993);
		if (!is_string($actionName)) throw new T3_FLOW3_MVC_Exception_InvalidActionName('The action name must be a valid string, ' . gettype($actionName) . ' given (' . $actionName . ').', 1187176358);
	...
	public function lock() {
		if ($this->locked) throw new T3_FLOW3_MVC_Exception_RequestObjectAlreadyLocked('This request object is locked for write access.', 1181135201);
		$this->locked = TRUE;
	}
}
