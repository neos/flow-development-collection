 ...
 * @package		FLOW3
 * @subpackage	Utility
 * @version     $Id:T3_FLOW3_Utility_SuperGlobalReplacement.php 467 2008-02-06 19:34:56Z robert $
 * @copyright   Copyright belongs to the respective authors
 * @license     http://opensource.org/licenses/gpl-license.php GNU Public License, version 2
 *
 * @scope prototype
 */
class T3_FLOW3_Utility_SuperGlobalReplacement extends ArrayObject {
