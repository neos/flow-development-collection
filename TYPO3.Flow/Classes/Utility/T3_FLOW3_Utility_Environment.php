...
#		$_SERVER = $componentManager->getComponent('T3_FLOW3_Utility_SuperGlobalReplacement', '_SERVER', 'Please use the ' . __CLASS__ . ' component instead of accessing the superglobal directly.');
