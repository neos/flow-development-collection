...
class Builder {
	...
	public function createObject($objectName, \F3\FLOW3\Object\Configuration\Configuration $objectConfiguration, array $overridingArguments = array()) {
		...
		try {
			...
			if (interface_exists($className) === TRUE) throw new \F3\FLOW3\Object\Exception\InvalidClass('No default implementation for the object type "' . $objectName . '" found in the object configuration. Cannot instantiate interface ' . $className . '.', 1238761260);
