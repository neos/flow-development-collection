 ...
 * @package		FLOW3
 * @subpackage	Package
 * @version 	$Id:T3_FLOW3_Package_Meta.php 203 2007-03-30 13:17:37Z robert $
 * @copyright	Copyright belongs to the respective authors
 * @license		http://opensource.org/licenses/gpl-license.php GNU Public License, version 2
 */
class T3_FLOW3_Package_Meta implements T3_FLOW3_Package_MetaInterface {
	...
	/**
	 * @var	T3_FLOW3_Package_Version	The version number
	 */
	protected $version;
