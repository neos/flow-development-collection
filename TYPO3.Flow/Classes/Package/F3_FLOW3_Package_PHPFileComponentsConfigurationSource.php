 ...
 * @package    FLOW3
 * @subpackage Package
 * @version    $Id:F3_FLOW3_Package_PHPFileComponentsConfigurationSource.php 203 2007-03-30 13:17:37Z robert $
 * @copyright  Copyright belongs to the respective authors
 * @license    http://opensource.org/licenses/gpl-license.php GNU Public License, version 2
 */
class F3_FLOW3_Package_PHPFileComponentsConfigurationSource implements F3_FLOW3_Package_ComponentsConfigurationSourceInterface {

	const FILENAME_COMPONENTSPHP = 'Components.php';
	...
	public function getComponentConfigurations(F3_FLOW3_Package_PackageInterface $package, $parsedComponentConfigurations) {
		$componentsConfigurationPath = $package->getConfigurationPath() . self::FILENAME_COMPONENTSPHP;
