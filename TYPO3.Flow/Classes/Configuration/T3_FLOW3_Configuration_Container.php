 ...
 */
class T3_FLOW3_Configuration_Container implements Countable, Iterator {
	 ...
	 * @throws T3_FLOW3_Configuration_Exception_ContainerIsLocked if the container is locked
	 * @author Robert Lemke <robert@typo3.org>
	 */
	public function __set($optionName, $optionValue) {
		if ($this->locked) throw new T3_FLOW3_Configuration_Exception_ContainerIsLocked('The configuration container is locked against write access.', 1206023011);
	...
	public function __unset($optionName) {
		if ($this->locked) throw new T3_FLOW3_Configuration_Exception_ContainerIsLocked('The configuration container is locked against write access.', 1206023012);
