...
class PropertyMappingConfigurationBuilder {
	...
	public function build($type = 'F3\FLOW3\Property\PropertyMappingConfiguration') {
		...
		$configuration->forAllProperties()->setTypeConverterOptions('F3\FLOW3\Property\TypeConverter\PersistentObjectConverter', array(
			\F3\FLOW3\Property\TypeConverter\PersistentObjectConverter::CONFIGURATION_CREATION_ALLOWED => FALSE,
			\F3\FLOW3\Property\TypeConverter\PersistentObjectConverter::CONFIGURATION_MODIFICATION_ALLOWED => FALSE
		));
