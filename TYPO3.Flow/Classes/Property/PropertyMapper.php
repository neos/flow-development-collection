...
use TYPO3\FLOW3\Utility\TypeHandling;
...
class PropertyMapper {
	...
	protected function findTypeConverter($source, $targetType, \TYPO3\FLOW3\Property\PropertyMappingConfigurationInterface $configuration) {
		...
		if ($converter === NULL) {
			throw new \TYPO3\FLOW3\Property\Exception\TypeConverterException('No converter found which can be used to convert from "' . $sourceType . '" to "' . $normalizedTargetType . '".');
		}
