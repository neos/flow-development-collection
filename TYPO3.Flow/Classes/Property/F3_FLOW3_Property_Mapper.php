...
class F3_FLOW3_Property_Mapper {
	 ...
	 * @todo   Implement
	 */
	public function registerPropertyEditor(F3_FLOW3_Property_EditorInterface $propertyEditor, $type, $property = '') {
	 ...
	 * 
	 * @return F3_FLOW3_Security_MappingResult		Result of the last mapping - NULL if none is available
	 * @author Robert Lemke <robert@typo3.org>
	 */
