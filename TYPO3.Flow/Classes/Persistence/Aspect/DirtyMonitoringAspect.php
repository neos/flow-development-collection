...
class DirtyMonitoringAspect {
	...
	/**
	 * @pointcut F3\FLOW3\Persistence\Aspect\DirtyMonitoringAspect->isEntityOrValueObject && !within(F3\FLOW3\Persistence\Aspect\DirtyMonitoringInterface)
	 * @author Karsten Dambekalns <karsten@typo3.org>
	 */
	public function needsDirtyCheckingAspect() {}

	/**
	 * @introduce F3\FLOW3\Persistence\Aspect\DirtyMonitoringInterface, F3\FLOW3\Persistence\Aspect\DirtyMonitoringAspect->needsDirtyCheckingAspect
	 */
	 ...
	 * @param \F3\FLOW3\AOP\JoinPointInterface $joinPoint The current join point
	 * @return boolean
	 * @around F3\FLOW3\Persistence\Aspect\DirtyMonitoringAspect->needsDirtyCheckingAspect && method(.*->FLOW3_Persistence_isNew())
	 ...
	 * @around F3\FLOW3\Persistence\Aspect\DirtyMonitoringAspect->needsDirtyCheckingAspect && method(.*->FLOW3_Persistence_isClone())
	 * @see \F3\FLOW3\Persistence\Aspect\DirtyMonitoringInterface
	 * @author Robert Lemke <robert@typo3.org>
	 */
	 ...
	 * @param \F3\FLOW3\AOP\JoinPointInterface $joinPoint The current join point
	 * @return boolean
	 * @around F3\FLOW3\Persistence\Aspect\DirtyMonitoringAspect->needsDirtyCheckingAspect && method(.*->FLOW3_Persistence_isDirty())
	 * @see \F3\FLOW3\Persistence\Aspect\DirtyMonitoringInterface
	 * @author Karsten Dambekalns <karsten@typo3.org>
	 */
