...
class T3_FLOW3_AOP_PointcutExpressionParser {
	...
	public function parse($pointcutExpression) {
		if (!is_string($pointcutExpression) || T3_PHP6_Functions::strlen($pointcutExpression) == 0) throw new T3_FLOW3_AOP_Exception_InvalidPointcutExpression('Pointcut expression must be a valid string.', 1168874738);	
