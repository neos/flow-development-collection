 ...
 * @version $Id: F3::FLOW3::Validation::Validator::Integer.php 681 2008-04-02 14:00:27Z andi $
 */
 ...
 */
class Integer implements F3::FLOW3::Validation::ValidatorInterface {
	...
	public function isValidProperty($propertyValue, F3::FLOW3::Validation::Errors &$errors) {
		...
		$errors->append($this->createNewValidationErrorObject('The given subject was not a valid integer. Got: "' . $propertyValue . '"', 1221560494));
		return FALSE;
	}
