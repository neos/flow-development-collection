 ...
 * @version $Id: F3::FLOW3::Validation::Validator::Alphanumeric.php 681 2008-04-02 14:00:27Z andi $
 */
 ...
 */
class Alphanumeric implements F3::FLOW3::Validation::ValidatorInterface {
	...
	/**
	 * Returns TRUE, if the given propterty ($proptertyValue) is a valid alphanumeric string.
	...
	public function isValidProperty($propertyValue, F3::FLOW3::Validation::Errors &$errors) {
		...
		if (preg_match('/^[A-Za-z0-9]*$/', $propertyValue)) return TRUE;

		$errors->append($this->createNewValidationErrorObject('The given subject was not a valid integer. Got: "' . $propertyValue . '"', 1221551320));
		return FALSE;
	}
