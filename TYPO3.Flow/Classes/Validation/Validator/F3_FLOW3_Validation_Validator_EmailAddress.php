 ...
 * @version $Id: F3_FLOW3_Validation_Validator_EmailAddress.php 681 2008-04-02 14:00:27Z andi $
 */
...
class F3_FLOW3_Validation_Validator_EmailAddress implements F3_FLOW3_Validation_ValidatorInterface {
	...
	public function isValidProperty($propertyValue, F3_FLOW3_Validation_Errors &$errors) {
		...
		return (boolean)preg_match('/\b[A-Z0-9._%+-]+@(?:[A-Z0-9-]+\.)+[A-Z]{2,4}\b/i', $propertyValue);
	}
}
