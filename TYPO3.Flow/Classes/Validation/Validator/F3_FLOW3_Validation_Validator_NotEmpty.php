 ...
 * @version $Id: F3::FLOW3::Validation::Validator::NotEmpty.php 681 2008-04-02 14:00:27Z andi $
 */
 ...
 */
class NotEmpty implements F3::FLOW3::Validation::ValidatorInterface {
	...
	public function isValidProperty($propertyValue, F3::FLOW3::Validation::Errors &$errors) {
		if ($propertyValue === NULL) $errors->append($this->createNewValidationErrorObject('The given subject was NULL.', 1221560910));
		if ($propertyValue === '') $errors->append($this->createNewValidationErrorObject('The given subject was empty.', 1221560718));
