...
class ValidatorResolver {
	...
	protected function resolveValidatorObjectName($validatorType) {
		...
		if ($this->objectManager->isRegistered($validatorType)
			&& $this->reflectionService->isClassImplementationOf($validatorType, 'TYPO3\FLOW3\Validation\Validator\ValidatorInterface')) {
		...
		if ($this->objectManager->isRegistered($possibleClassName)
			&& $this->reflectionService->isClassImplementationOf($possibleClassName, 'TYPO3\FLOW3\Validation\Validator\ValidatorInterface')) {
