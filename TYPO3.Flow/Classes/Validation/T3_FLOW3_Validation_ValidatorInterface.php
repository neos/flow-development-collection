 ...
 * @version 	$Id:T3_FLOW3_Validation_ValidatorInterface.php 467 2008-02-06 19:34:56Z robert $
 * @copyright	Copyright belongs to the respective authors
 * @author		Robert Lemke <robert@typo3.org>
 * @license		http://opensource.org/licenses/gpl-license.php GNU Public License, version 2
 */
interface T3_FLOW3_Validation_ValidatorInterface {
	 ...
	 * @throws T3_FLOW3_Security_Validation_Exception_InvalidSubject if this validator cannot validate the given subject or the subject is not an object.
	 */
	public function validate($subject, T3_FLOW3_Security_Validation_Errors $errors);
}
