...
class MapperTest extends F3::Testing::BaseTestCase {
	...
	public function test_checkIfItsPrototype() {
		$mapper1 = $this->componentFactory->getComponent('F3::FLOW3::Property::Mapper');
		$mapper2 = $this->componentFactory->getComponent('F3::FLOW3::Property::Mapper');
	...
	public function mapperOnlyAcceptsObjectsAsTarget() {
		try {
			$mapper = $this->componentFactory->getComponent('F3::FLOW3::Property::Mapper');
