...
class ObjectManagerTest extends \F3\Testing\BaseTestCase {
	...
	public function injectReflectionServiceRegistersTheObjectAndClassnameCorrectly() {
		$objectManager = $this->getMock($this->buildAccessibleProxy('F3\FLOW3\Object\ObjectManager'), array('dummy'), array(), '', FALSE);
		...
		$this->assertEquals($objectManager->_get('registeredObjects'), array('F3\FLOW3\Reflection\ReflectionService' => 'f3\flow3\reflection\reflectionservice'));
		$this->assertEquals($objectManager->_get('registeredClasses'), array('F3\FLOW3\Reflection\ReflectionService' => 'F3\FLOW3\Reflection\ReflectionService'));
	}
	...
	public function initializeManagerRegistersTheObjectManagerAndAllInjectedDependenciesAsManagedObjects() {
		$mockReflectionService = $this->getMock('F3\FLOW3\Reflection\ReflectionService', array(), array(), '', FALSE, FALSE);
		...
		$mockConfigurationManager = $this->getMock('F3\FLOW3\Configuration\ConfigurationManager', array('getConfiguration'), array(), '', FALSE, FALSE);
		...
		$objectFactory = new \F3\FLOW3\Object\ObjectFactory();
		...
		$this->assertSame($objectManager, $objectManager->getObject('F3\FLOW3\Object\ObjectManagerInterface'));
		$this->assertSame($mockReflectionService, $objectManager->getObject('F3\FLOW3\Reflection\ReflectionService'));
		$this->assertSame($objectBuilder, $objectManager->getObject('F3\FLOW3\Object\ObjectBuilder'));
		$this->assertSame($objectFactory, $objectManager->getObject('F3\FLOW3\Object\ObjectFactoryInterface'));
	...
	public function initializeObjectsLoadsObjectConfigurationsFromCacheIfAvailable() {
		...
		$objectManager = $this->getMock($this->buildAccessibleProxy('F3\FLOW3\Object\ObjectManager'), array('setObjectConfigurations'), array(), '', FALSE);
	...
	public function initializeObjectsRegistersClassesFromPackagesIfObjectConfigurationIsNotCached() {
		...
		$objectManager = $this->getMock($this->buildAccessibleProxy('F3\FLOW3\Object\ObjectManager'), array('registerAndConfigureAllPackageObjects'), array(), '', FALSE);
		$objectManager->injectObjectConfigurationsCache($mockObjectsConfigurationCache);
	...
	public function getObjectCreatesANewInstanceOfSessionObjectsAndStoresItInTheSessionRegistryIfAnInstanceDoesntExistYet() {
		...
		$objectManager = $this->getMock($this->buildAccessibleProxy('F3\FLOW3\Object\ObjectManager'), array('isObjectRegistered', 'getOverridingArguments', 'registerShutdownObject'), array(), '', FALSE);
	...
	public function registerObjectPutsTheObjectIntoTheRegistryIfOneWasGiven() {
		...
		$mockRegistry->expects($this->at(0))->method('putObject')->with('F3\FLOW3\Reflection\ReflectionService', $mockReflectionService);
	...
	public function unregisterObjectRemovesTheClassFromTheRegisteredClassesArray() {
		...
		$objectManager = $this->getMock($this->buildAccessibleProxy('F3\FLOW3\Object\ObjectManager'), array('isObjectRegistered'), array(), '', FALSE);
		$objectManager->injectObjectBuilder($this->getMock('F3\FLOW3\Object\ObjectBuilder'));
	...
	public function setObjectConfigurationStoresACloneOfTheOriginalConfigurationObject() {
		$objectManager = $this->getMock($this->buildAccessibleProxy('F3\FLOW3\Object\ObjectManager'), array('dummy'));
	...
	public function setObjectConfigurationsDelegatesToSetObjectConfiguration() {
		...
		$objectManager = $this->getMock($this->buildAccessibleProxy('F3\FLOW3\Object\ObjectManager'), array('setObjectConfiguration'));
