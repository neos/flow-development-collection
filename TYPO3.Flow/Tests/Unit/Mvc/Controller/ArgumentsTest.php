...
class ArgumentsTest extends \TYPO3\Flow\Tests\UnitTestCase
{
    ...
    public function getValidationResultsShouldFetchAllValidationResltsFromArguments()
    {
        ...
        $argument1 = $this->getMockBuilder('TYPO3\Flow\Mvc\Controller\Argument')->setMethods(array('getValidationResults'))->setConstructorArgs(array('name1', 'string'))->getMock();
        $argument1->expects($this->once())->method('getValidationResults')->will($this->returnValue($results1));

        $argument2 = $this->getMockBuilder('TYPO3\Flow\Mvc\Controller\Argument')->setMethods(array('getValidationResults'))->setConstructorArgs(array('name2', 'string'))->getMock();
