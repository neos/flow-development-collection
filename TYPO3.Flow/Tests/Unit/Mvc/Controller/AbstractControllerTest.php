...
class AbstractControllerTest extends UnitTestCase
{
    ...
    public function redirectRedirectsToTheSpecifiedAction()
    {
        ...
        $mockUriBuilder = $this->createMock('TYPO3\Flow\Mvc\Routing\UriBuilder');
    ...
    {
        $mockPropertyMapper = $this->getMockBuilder('TYPO3\Flow\Property\PropertyMapper')->disableOriginalConstructor()->setMethods(array('convert'))->getMock();
