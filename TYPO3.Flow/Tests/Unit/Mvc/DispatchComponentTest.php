...
class DispatchComponentTest extends UnitTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->mockObjectManager->expects($this->any())->method('get')->with(ActionRequest::class, $this->mockHttpRequest)->will($this->returnValue($this->mockActionRequest));
        ...
        $this->mockPropertyMappingConfiguration = $this->getMockBuilder(PropertyMappingConfiguration::class)->disableOriginalConstructor()->getMock();
    ...
    public function handleMergesInternalArgumentsWithRoutingMatchResults()
    {
        ...
        $this->mockPropertyMapper->expects($this->any())->method('convert')->with('', 'array', $this->mockPropertyMappingConfiguration)->will($this->returnValue(['__internalArgument2' => 'requestBody', '__internalArgument3' => 'requestBody']));
