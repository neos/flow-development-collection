...
class RouterTest extends UnitTestCase
{
    ...
    public function resolveCallsCreateRoutesFromConfiguration()
    {
        ...
        $mockRoute = $this->createMock('TYPO3\Flow\Mvc\Routing\Route');
    ...
    public function resolveIteratesOverTheRegisteredRoutesAndReturnsTheResolvedUriPathIfAny()
    {
        ...
        $route1 = $this->getMockBuilder('TYPO3\Flow\Mvc\Routing\Route')->disableOriginalConstructor()->setMethods(array('resolves'))->getMock();
        $route1->expects($this->once())->method('resolves')->with($routeValues)->will($this->returnValue(false));

        $route2 = $this->getMockBuilder('TYPO3\Flow\Mvc\Routing\Route')->disableOriginalConstructor()->setMethods(array('resolves', 'getResolvedUriPath'))->getMock();
        ...
        $route3 = $this->getMockBuilder('TYPO3\Flow\Mvc\Routing\Route')->disableOriginalConstructor()->setMethods(array('resolves'))->getMock();
    ...
    public function resolveThrowsExceptionIfNoMatchingRouteWasFound()
    {
        ...
        $route1 = $this->createMock('TYPO3\Flow\Mvc\Routing\Route');
        $route1->expects($this->once())->method('resolves')->will($this->returnValue(false));

        $route2 = $this->createMock('TYPO3\Flow\Mvc\Routing\Route');
