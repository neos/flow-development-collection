...
class UriBuilderTest extends UnitTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->mockRouter = $this->createMock('TYPO3\Flow\Mvc\Routing\RouterInterface');

        $this->mockMainRequest = $this->createMock('TYPO3\Flow\Mvc\ActionRequest', array(), array($this->mockHttpRequest));
        ...
        $this->mockSubRequest = $this->createMock('TYPO3\Flow\Mvc\ActionRequest', array(), array($this->mockMainRequest));
        ...
        $this->mockSubSubRequest = $this->createMock('TYPO3\Flow\Mvc\ActionRequest', array(), array($this->mockSubRequest));
        ...
        $environment = $this->getMockBuilder('TYPO3\Flow\Utility\Environment')->disableOriginalConstructor()->setMethods(array('isRewriteEnabled'))->getMock();
    ...
    {
        $this->mockRouter->expects($this->once())->method('resolve')->will($this->returnValue('resolvedUri'));
        $mockEnvironment = $this->getMockBuilder('TYPO3\Flow\Utility\Environment')->disableOriginalConstructor()->setMethods(array('isRewriteEnabled'))->getMock();
