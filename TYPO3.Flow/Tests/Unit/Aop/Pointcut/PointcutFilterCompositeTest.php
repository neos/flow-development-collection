...
class PointcutFilterCompositeTest extends \TYPO3\Flow\Tests\UnitTestCase
{
    ...
    public function getRuntimeEvaluationsDefintionReturnsTheEvaluationsFromAllContainedFiltersThatMatchedThePointcutWithTheCorrectOperators()
    {
        ...
        $mockPointcutFilter1 = $this->getMockBuilder('TYPO3\Flow\Aop\Pointcut\PointcutFilterInterface')->disableOriginalConstructor()->getMock();
        ...
        $mockPointcutFilter2 = $this->getMockBuilder('TYPO3\Flow\Aop\Pointcut\PointcutFilterInterface')->disableOriginalConstructor()->getMock();
        ...
        $mockPointcutFilter3 = $this->getMockBuilder('TYPO3\Flow\Aop\Pointcut\PointcutFilterInterface')->disableOriginalConstructor()->getMock();
        ...
        $mockPointcutFilter4 = $this->getMockBuilder('TYPO3\Flow\Aop\Pointcut\PointcutFilterInterface')->disableOriginalConstructor()->getMock();
        ...
        $mockPointcutFilter5 = $this->getMockBuilder('TYPO3\Flow\Aop\Pointcut\PointcutFilterInterface')->disableOriginalConstructor()->getMock();
    ...
    public function globalRuntimeEvaluationsDefinitionAreAddedCorrectlyToThePointcutFilterComposite()
    {
        ...
        $pointcutFilterComposite = $this->getAccessibleMock('TYPO3\Flow\Aop\Pointcut\PointcutFilterComposite', array('dummy'), array(), '', false);
