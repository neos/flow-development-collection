...
class PointcutMethodAnnotatedWithFilterTest extends \TYPO3\Flow\Tests\UnitTestCase
{
    ...
    {
        $mockReflectionService = $this->createMock('TYPO3\Flow\Reflection\ReflectionService', array('getMethodAnnotations'), array(), '', false, true);
    ...
    {
        $mockReflectionService = $this->createMock('TYPO3\Flow\Reflection\ReflectionService', array(), array(), '', false, true);
