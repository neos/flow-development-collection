...
class DataMapperTest extends \F3\FLOW3\Tests\UnitTestCase {
	...
	public function mapToObjectReconstitutesExpectedObjectAndRegistersItWithIdentitymapToObjects() {
		...
		$mockEntity = $this->getMock('F3\FLOW3\AOP\ProxyInterface', array('FLOW3_AOP_Proxy_construct', 'FLOW3_AOP_Proxy_invokeJoinPoint', 'FLOW3_AOP_Proxy_hasProperty', 'FLOW3_AOP_Proxy_getProxyTargetClassName'), array(), $mockEntityClassName);
