...
class PolicyExpressionParserTest extends \TYPO3\Flow\Tests\UnitTestCase
{
    ...
    {
        $parser = $this->getMockBuilder('TYPO3\Flow\Security\Authorization\Privilege\Method\MethodTargetExpressionParser')->setMethods(array('parseDesignatorMethod'))->getMock();
