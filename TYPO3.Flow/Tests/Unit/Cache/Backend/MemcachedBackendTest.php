...
class MemcachedBackendTest extends \TYPO3\Flow\Tests\UnitTestCase
{
    ...
    public function flushRemovesOnlyOwnEntries()
    {
        ...
        $thisCache = $this->getMockBuilder('TYPO3\Flow\Cache\Frontend\AbstractFrontend')->disableOriginalConstructor()->getMock();
        ...
        $thatCache = $this->getMockBuilder('TYPO3\Flow\Cache\Frontend\AbstractFrontend')->disableOriginalConstructor()->getMock();
