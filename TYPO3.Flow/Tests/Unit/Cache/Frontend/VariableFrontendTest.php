...
class VariableFrontendTest extends \TYPO3\Flow\Tests\UnitTestCase
{
    ...
    public function setPassesSerializedStringToBackend()
    {
        ...
        $backend = $this->getMockBuilder('TYPO3\Flow\Cache\Backend\AbstractBackend')->disableOriginalConstructor()->setMethods(array('get', 'set', 'has', 'remove', 'findIdentifiersByTag', 'flush', 'flushByTag', 'collectGarbage'))->getMock();
    ...
    {
        $backend = $this->getMockBuilder('TYPO3\Flow\Cache\Backend\TaggableBackendInterface')->disableOriginalConstructor()->getMock();
