...
class XliffTranslationProviderTest extends \TYPO3\Flow\Tests\UnitTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->mockPluralsReader = $this->createMock('TYPO3\Flow\I18n\Cldr\Reader\PluralsReader');
    }
    ...
    {
        $mockModel = $this->createMock('TYPO3\Flow\I18n\Xliff\XliffModel', array(), array('foo', $this->sampleLocale));
        ...
        $translationProvider = $this->getAccessibleMock('TYPO3\Flow\I18n\TranslationProvider\XliffTranslationProvider', array('getModel'));
    ...
    public function getTranslationByOriginalLabelThrowsExceptionWhenInvalidPluralFormProvided()
    {
        ...
        $translationProvider = $this->getMockBuilder('TYPO3\Flow\I18n\TranslationProvider\XliffTranslationProvider')->setMethods(array('getModel'))->getMock();
        $translationProvider->injectPluralsReader($this->mockPluralsReader);
    ...
    public function getModelSetsCorrectLocaleInModel()
    {
        ...
        $translationProvider = $this->getAccessibleMock('TYPO3\Flow\I18n\TranslationProvider\XliffTranslationProvider', array('dummy'));
