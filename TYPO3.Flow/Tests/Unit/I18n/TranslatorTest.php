...
class TranslatorTest extends \TYPO3\Flow\Tests\UnitTestCase
{
    ...
    {
        $mockTranslationProvider = $this->createMock('TYPO3\Flow\I18n\TranslationProvider\XliffTranslationProvider');
        ...
        $mockFormatResolver = $this->createMock('TYPO3\Flow\I18n\FormatResolver');
        ...
        $mockPluralsReader = $this->createMock('TYPO3\Flow\I18n\Cldr\Reader\PluralsReader');
