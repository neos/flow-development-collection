 ...
 */
class T3_FLOW3_AOP_PointcutTest extends T3_Testing_BaseTestCase {
	...
	public function withinDesignatorBasicallyWorks() {
		$pointcut = $this->AOPFramework->findPointcut('T3_TestPackage_PointcutTestingAspect', 'serviceLayerClasses');
