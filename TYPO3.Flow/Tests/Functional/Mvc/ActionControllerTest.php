...
class ActionControllerTest extends \TYPO3\FLOW3\Tests\FunctionalTestCase {
	...
	public function objectArgumentsAreValidatedByDefault() {
		...
		$expectedResult = 'Validation failed while trying to call TYPO3\FLOW3\Tests\Functional\Mvc\Fixtures\Controller\ActionControllerTestBController->requiredObjectAction().' . PHP_EOL;
		$this->assertEquals($expectedResult, $response->getContent());
	}
	...
	public function optionalObjectArgumentsAreValidatedByDefault() {
		...
		$expectedResult = 'Validation failed while trying to call TYPO3\FLOW3\Tests\Functional\Mvc\Fixtures\Controller\ActionControllerTestBController->optionalObjectAction().' . PHP_EOL;
		$this->assertEquals($expectedResult, $response->getContent());
	}
	...
	public function argumentTestsDataProvider() {
		...
		return array(
			...
			'required integer - mapping error'  => array('requiredInteger', 'not an integer', 'Validation failed while trying to call TYPO3\FLOW3\Tests\Functional\Mvc\Fixtures\Controller\ActionControllerTestBController->requiredIntegerAction().'),
			...
			'optional integer - mapping error'  => array('optionalInteger', 'not an integer', 'Validation failed while trying to call TYPO3\FLOW3\Tests\Functional\Mvc\Fixtures\Controller\ActionControllerTestBController->optionalIntegerAction().'),
			...
			'required float - mapping error'    => array('requiredFloat', 'not a float', 'Validation failed while trying to call TYPO3\FLOW3\Tests\Functional\Mvc\Fixtures\Controller\ActionControllerTestBController->requiredFloatAction().'),
			...
			'optional float - mapping error'    => array('optionalFloat', 'not a float', 'Validation failed while trying to call TYPO3\FLOW3\Tests\Functional\Mvc\Fixtures\Controller\ActionControllerTestBController->optionalFloatAction().'),
			...
			'required date - mapping error'     => array('requiredDate', 'no date', 'Validation failed while trying to call TYPO3\FLOW3\Tests\Functional\Mvc\Fixtures\Controller\ActionControllerTestBController->requiredDateAction().'),
			...
			'optional date - mapping error'     => array('optionalDate', 'no date', 'Validation failed while trying to call TYPO3\FLOW3\Tests\Functional\Mvc\Fixtures\Controller\ActionControllerTestBController->optionalDateAction().'),
