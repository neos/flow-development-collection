<?php
namespace TYPO3\FLOW3\Tests\Functional\Property\TypeConverter;
 ...
 *
 */
class FloatConverterTest extends \TYPO3\FLOW3\Tests\FunctionalTestCase {

	/**
	 * @var \TYPO3\FLOW3\Property\TypeConverter\FloatConverter
	 */
	protected $converter;
	 ...
	 *
	 * @param \TYPO3\FLOW3\I18n\Locale|string $locale
	 * @param $source
	...
	public function convertFromUsingVariousLocalesParsesFloatCorrectly($locale, $source, $expectedResult) {
		...
		$configuration->setTypeConverterOption('TYPO3\FLOW3\Property\TypeConverter\FloatConverter', 'locale', $locale);
	...
	public function convertFromReturnsErrorIfFormatIsInvalid() {
		$configuration = new \TYPO3\FLOW3\Property\PropertyMappingConfiguration();
		$configuration->setTypeConverterOption('TYPO3\FLOW3\Property\TypeConverter\FloatConverter', 'locale', 'de');
		...
		$this->assertInstanceOf('TYPO3\FLOW3\Error\Error', $this->converter->convertFrom('84,00', 'float'));
	}
