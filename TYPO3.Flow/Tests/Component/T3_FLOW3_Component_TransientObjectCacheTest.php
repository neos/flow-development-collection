 ...
 */
class T3_FLOW3_Component_TransientObjectCacheTest extends T3_Testing_BaseTestCase {
	...
	public function getComponentObjectReturnsSameObjectWhichHasBeenStoredByPutComponentObject() {
		$originalObject = new T3_FLOW3_Fixture_DummyClass();
	...
	public function putComponentObjectThrowsExceptionsOnInvalidArguments() {
		$someObject = new T3_FLOW3_Fixture_DummyClass();
		$exceptionsThrown = 0;
		try {
