 ...
 */
class T3_FLOW3_MVC_CLI_RequestHandlerTest extends T3_Testing_BaseTestCase {
	...
	protected function setUp() {
		...
		$requestBuilder = $this->componentManager->getComponent('T3_FLOW3_MVC_CLI_RequestBuilder', $this->componentManager, $this->environment);
		$this->requestHandler = $this->componentManager->getComponent('T3_FLOW3_MVC_CLI_RequestHandler', $this->componentManager, $this->environment);
	}
