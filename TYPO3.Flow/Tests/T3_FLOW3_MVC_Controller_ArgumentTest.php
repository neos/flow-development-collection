...
class T3_FLOW3_MVC_Controller_ArgumentTest extends T3_Testing_BaseTestCase {
	...
	public function constructingArgumentWithoutNameThrowsException() {
		try {
			$argument = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Argument');
	...
	public function constructingArgumentWithInvalidNameThrowsException() {
		try {
			$argument = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Argument', new ArrayObject());
	...
	public function passingDataTypeToConstructorReallySetsTheDataType() {
		$argument = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Argument', 'dummy', 'number');
	...
	public function setShortNameProvidesFluentInterface() {
		$argument = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Argument', 'dummy');
