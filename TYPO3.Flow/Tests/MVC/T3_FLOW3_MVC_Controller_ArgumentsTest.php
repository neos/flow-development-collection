 ...
 * 
 * @package		FLOW3
 * @version 	$Id:T3_FLOW3_MVC_Controller_ArgumentsTest.php 201 2007-09-10 23:58:30Z Andi $
 * @copyright	Copyright belongs to the respective authors
 * @license		http://opensource.org/licenses/gpl-license.php GNU Public License, version 2
 */
class T3_FLOW3_MVC_Controller_ArgumentsTest extends T3_Testing_BaseTestCase {
	...
	public function argumentsObjectIsOfScopePrototype() {
		$arguments1 = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Arguments');
		$arguments2 = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Arguments');
	...
	public function addingAnArgumentManuallyWorks() {
		$arguments = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Arguments');
		$newArgument = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Argument', 'argumentName1234');
	...
	public function addingAnArgumentReplacesArgumentWithSameName() {
		...
		$firstArgument = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Argument', 'argumentName1234');
		$arguments->addArgument($firstArgument);

		$secondArgument = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Argument', 'argumentName1234');
	...
	public function addNewArgumentProvidesFluentInterface() {
		...
		$this->assertType('T3_FLOW3_MVC_Controller_Argument', $newArgument, 'addNewArgument() did not return an argument object.');
	}
	...
	public function addingArgumentThroughArrayAccessWorks() {
		$arguments = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Arguments');
		$argument = $this->componentManager->getComponent('T3_FLOW3_MVC_Controller_Argument', 'argumentName1234');
		$arguments[] = $argument;
	...
	public function getArgumentWithNonExistingArgumentNameThrowsException() {
		...
		} catch (T3_FLOW3_MVC_Exception_NoSuchArgument $exception) {
		}
	}
	...
	public function addNewArgumentCreatesAndAddsNewArgument() {
		...
		$this->assertType('T3_FLOW3_MVC_Controller_Argument', $addedArgument, 'addNewArgument() either did not add a new argument or did not return it.');
