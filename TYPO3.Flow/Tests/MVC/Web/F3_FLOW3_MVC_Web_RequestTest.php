...
class RequestTest extends F3::Testing::BaseTestCase {
	...
	protected function setUp() {
		...
		$this->requestURI = $this->componentFactory->getComponent('F3::FLOW3::Property::DataType::URI', $URIString);
	}
	...
	public function webRequestIsPrototype() {
		$request1 = $this->componentFactory->getComponent('F3::FLOW3::MVC::Web::Request');
		$request2 = $this->componentFactory->getComponent('F3::FLOW3::MVC::Web::Request');
