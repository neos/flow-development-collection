...
class UriPatternSegmentCollectionTest extends F3::Testing::BaseTestCase {
	...
	public function uriPatternSegmentCollectionIsPrototype() {
		$uriPatternSegmentCollection1 = $this->componentFactory->create('F3::FLOW3::MVC::Web::Routing::UriPatternSegmentCollection');
		$uriPatternSegmentCollection2 = $this->componentFactory->create('F3::FLOW3::MVC::Web::Routing::UriPatternSegmentCollection');
