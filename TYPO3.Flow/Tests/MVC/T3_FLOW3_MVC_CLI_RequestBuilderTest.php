 ...
 */
class T3_FLOW3_MVC_CLI_RequestBuilderTest extends T3_Testing_BaseTestCase {

	/**
	 * @var T3_FLOW3_MVC_CLI_RequestBuilder
	 */
	...
	public function setUp() {
		$this->environment = $this->componentManager->getComponent('T3_FLOW3_Utility_MockEnvironment');
		$this->requestBuilder = $this->componentManager->getComponent('T3_FLOW3_MVC_CLI_RequestBuilder', $this->componentManager, $this->environment);
	}
	...
	public function simpleCLIAccessBuildsCorrectRequest() {
		...
		$this->assertEquals('T3_FLOW3_MVC_Controller_DefaultController', $request->getControllerName(), 'The CLI request without any arguments did not return a request object pointing to the default controller.');
	}
	...
	public function CLIAccessWithPackageNameBuildsCorrectRequest() {
		...
		$request = $this->requestBuilder->build();
		$this->assertEquals('T3_TestPackage_Controller_Default', $request->getControllerName(), 'The CLI request specifying a package name did not return a request object pointing to the expected controller.');
	}
	...
	public function CLIAccessWithPackageAndControllerNameBuildsCorrectRequest() {
		...
		$request = $this->requestBuilder->build();
		$this->assertEquals('T3_TestPackage_Controller_Default', $request->getControllerName(), 'The CLI request specifying a package name and controller did not return a request object pointing to the expected controller.');
	}
