 ...
 */
class RequestHandlerResolverTest extends \F3\Testing\BaseTestCase {
	...
	public function theRequestHandlersAreFoundByTheirInterfaceAndAreThenChosenByTheirFitAndPriority() {
		...
		$mockObjectManager->expects($this->at(0))->method('getObject')->with('RequestHandler1')->will($this->returnValue($mockRequestHandler1));
		$mockObjectManager->expects($this->at(1))->method('getObject')->with('RequestHandler2')->will($this->returnValue($mockRequestHandler2));
