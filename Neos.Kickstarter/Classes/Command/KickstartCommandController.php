...
class KickstartCommandController extends CommandController
{
    ...
    public function translationCommand($packageKey, $languageKey)
    {
        ...
        $generateFiles = $this->generatorService->generateTranslation($packageKey, $languageKey);
