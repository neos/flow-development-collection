...
class Translator
{
     ...
     * @api
     */
    public function translateByOriginalLabel($originalLabel, array $arguments = array(), $quantity = null, Locale $locale = null, $sourceName = 'Main', $packageKey = 'TYPO3.Flow')
    {
        if ($locale === null) {
     ...
     */
    public function translateById($labelId, array $arguments = array(), $quantity = null, Locale $locale = null, $sourceName = 'Main', $packageKey = 'TYPO3.Flow')
    {
        if ($locale === null) {
            $locale = $this->localizationService->getConfiguration()->getCurrentLocale();
        }
