...
.. |Travis Build Status| image:: https://travis-ci.org/neos/flow-development-collection.svg?branch=3.0
...
.. |Docs| image:: https://img.shields.io/badge/documentation-3.0-blue.svg
   :target: https://flowframework.readthedocs.org/en/3.0/
   :alt: Documentation
.. |API| image:: https://img.shields.io/badge/API%20docs-3.0-blue.svg
   :target: http://neos.github.io/flow/3.0/
   :alt: API Docs
...
If you want to use the Flow framework, please have a look at the documentation: https://flowframework.readthedocs.org/en/3.0/
