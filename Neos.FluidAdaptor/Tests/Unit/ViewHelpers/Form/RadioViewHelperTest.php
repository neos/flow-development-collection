...
class RadioViewHelperTest extends \Neos\FluidAdaptor\Tests\Unit\ViewHelpers\Form\FormFieldViewHelperBaseTestcase
{
    ...
    public function renderIgnoresBoundPropertyIfCheckedIsSet()
    {
        ...
        $this->viewHelper->expects($this->any())->method('getPropertyValue')->will(self::returnValue('propertyValue'));
        $this->viewHelper->injectTagBuilder($this->mockTagBuilder);
    ...
    public function renderCorrectlySetsCheckedAttributeIfCheckboxIsBoundToAPropertyOfTypeString()
    {
        ...
        $this->viewHelper->expects($this->any())->method('getValueAttribute')->will(self::returnValue('bar'));
        $this->viewHelper->expects($this->any())->method('isObjectAccessorMode')->will(self::returnValue(true));
        $this->viewHelper->expects($this->any())->method('getPropertyValue')->will(self::returnValue('bar'));
        $this->viewHelper->injectTagBuilder($this->mockTagBuilder);
