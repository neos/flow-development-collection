 ...
 * which can be found in the Scripts folder of the Neos.Utility.MediaTypes package.
 *
 * @see http://www.iana.org/assignments/media-types/
 */
abstract class MediaTypes
{
    public const PATTERN_SPLITMEDIARANGE = '/^(?P<type>(?:\*|[\.!#%&\'\`\^~\$\*\+\-\|\w]+))\/(?P<subtype>(?:\*|[\.!#%&\'\`\^~\$\*\+\-\|\w]+))(?P<parameters>.*)$/i';
    public const PATTERN_SPLITMEDIATYPE = '/^(?P<type>(?:[\.!#%&\'\`\^~\$\*\+\-\|\w]+))\/(?P<subtype>(?:[\.!#%&\'\`\^~\$\*\+\-\|\w]+))(?P<parameters>.*)$/i';
    ...
    public static function mediaRangeMatches(string $mediaRange, string $mediaType): bool
    {
        ...
        if ($mediaRangeMatches === [] || $mediaTypeMatches === []) {
            return false;
        }
